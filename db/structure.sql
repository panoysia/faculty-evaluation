...
CREATE TABLE "academic_years" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "start_at" date NOT NULL, "end_at" date NOT NULL, "created_at" datetime NOT NULL, "updated_at" datetime NOT NULL);
...
CREATE TABLE "career_path_actions" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "name" varchar NOT NULL, "start_at" date, "end_at" date, "description" varchar, "category" integer NOT NULL, "created_at" datetime NOT NULL, "updated_at" datetime NOT NULL, "career_path_id" integer NOT NULL, "company" varchar);
...
CREATE TABLE "qce_rating_evaluations" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "question_id" integer NOT NULL, "score" integer, "rating_id" integer NOT NULL, "rating_type" varchar NOT NULL, "created_at" datetime NOT NULL, "updated_at" datetime NOT NULL);
CREATE TABLE "qce_rating_tasks" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "owner_id" integer NOT NULL, "evaluator_id" integer NOT NULL, "evaluator_type" varchar NOT NULL, "rating_id" integer NOT NULL, "rating_type" varchar NOT NULL, "status" integer NOT NULL, "created_at" datetime NOT NULL, "updated_at" datetime NOT NULL);
...
CREATE TABLE "specializations" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "name" varchar(50) NOT NULL, "created_at" datetime NOT NULL, "updated_at" datetime NOT NULL, "career_path_id" integer NOT NULL);
...
CREATE INDEX "index_career_path_actions_on_career_path_id" ON "career_path_actions" ("career_path_id");
...
CREATE INDEX "index_employees_on_career_path_id" ON "employees" ("career_path_id");
...
CREATE INDEX "index_qce_rating_tasks_on_owner_id" ON "qce_rating_tasks" ("owner_id");
