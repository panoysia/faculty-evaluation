...
ActiveRecord::Schema.define(version: 20161009103527) do
  ...
  create_table "employee_academic_work_experiences", force: :cascade do |t|
    t.integer  "employee_id",                 null: false
    t.date     "start_at",                    null: false
    t.date     "end_at",                      null: false
  ...
  create_table "employee_admin_work_experiences", force: :cascade do |t|
    t.integer  "employee_id",            null: false
  ...
  create_table "employee_consultancy_services", force: :cascade do |t|
    t.integer  "employee_id",                                      null: false
  ...
  add_index "employee_consultancy_services", ["employee_id"], name: "index_employee_consultancy_services_on_employee_id"
  ...
  create_table "employee_professional_work_experiences", force: :cascade do |t|
    t.integer  "employee_id",            null: false
    t.integer  "position",               null: false
    t.string   "institution", limit: 75, null: false
    t.date     "start_at",               null: false
  ...
  add_index "employee_professional_work_experiences", ["employee_id"], name: "index_employee_professional_work_experiences_on_employee_id"

  create_table "employee_public_private_work_experiences", force: :cascade do |t|
  ...
  add_index "employee_public_private_work_experiences", ["employee_id"], name: "index_employee_public_private_work_experiences_on_employee_id"
