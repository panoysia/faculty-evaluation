class User::CCERecord::PublicPrivateWorkExperiencesController < User::ApplicationController
  ...
  def new
    @work_experience = employee.public_private_work_experiences.new
  end
  ...
  def create
    ...
    if @work_experience.save
      redirect_to cce_record_path,
        notice: "Public/private work experience record was successfully created."
    else
      render :new
    end
  end
